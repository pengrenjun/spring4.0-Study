...
public class XhContractExecutionBeanPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        if(org.apache.commons.lang.StringUtils.equals(beanName,"xhContractExecution")){

            Predicate<XhContractExecution> predicate=new Predicate<XhContractExecution>() {
                @Override
                public boolean apply(XhContractExecution input) {
                    if(org.apache.commons.lang.StringUtils.isNotEmpty(input.getId())){
                        return true;
                    }
                    return false;
                }
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if(org.apache.commons.lang.StringUtils.equals(beanName,"xhContractExecution")){
            ...
            Predicate<XhContractExecution> predicate=new Predicate<XhContractExecution>() {
                @Override
                public boolean apply(XhContractExecution input) {
                    if(org.apache.commons.lang.StringUtils.isNotEmpty(input.getDeptName())){
                        return true;
                    }
                    return false;
                }
