package com.smart.springJdbc.main.java.com.gupaoedu.vip.jdbc.framework;
...
import com.smart.springJdbc.main.java.javax.core.common.Page;
import com.smart.springJdbc.main.java.javax.core.common.utils.BeanUtils;
import com.smart.springJdbc.main.java.javax.core.common.utils.DataUtils;
import com.smart.springJdbc.main.java.javax.core.common.utils.GenericsUtils;
import com.smart.springJdbc.main.java.javax.core.common.utils.StringUtils;
...
public abstract class BaseDaoSupport<T extends Serializable, PK extends Serializable>{
	...
	protected long getCount(QueryRule queryRule) throws Exception {
		...
		//return this.jdbcTemplateReadOnly().queryForLong(countSql, values);在spring 3.2.2之后，jdbcTemplate.queryForInt已经被取消了！
	...
	private <T> Page simplePageQueryByStart(String sql, RowMapper<T> rowMapper, Map<String, ?> args, long start, long pageSize) {
        ...
        Object[] valus=null;
        long count= this.jdbcTemplateReadOnly().queryForObject(countSql, valus, Long.class);
		if (count == 0) {
			log.debug("no result..");
			return new Page();
		}
	...
	protected long queryCount(String sql,Map<String, ?> args){
        ...
        Object[] valus=null;
        return  this.jdbcTemplateReadOnly().queryForObject(countSql, valus, Long.class);
	}
