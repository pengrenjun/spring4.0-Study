...
public  class XhContractExecution   implements BeanFactoryAware, BeanNameAware, InitializingBean/*,InstantiationAwareBeanPostProcessor,BeanPostProcessor 通过注册自定义后处理器实现*/ {
